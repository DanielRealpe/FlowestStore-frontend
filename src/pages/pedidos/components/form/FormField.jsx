...
const FormField = ({ type = "text", name, label, value, error, onChange, className = "", icon, placeholder }) => {
    ...
    <div className={`mb-4 ${className}`}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full border rounded-lg p-2.5 text-sm transition-all duration-200 ${icon ? "pl-9" : ""} ${
            error
              ? darkMode
